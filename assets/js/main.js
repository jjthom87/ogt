(function ($) {
	...
	$(".add-to-cart-btn").on("click", function(){
		...
		if(localStorage.getItem("cart")){
			currentCart = JSON.parse(localStorage.getItem("cart").split(","));
		}

		const newCartItem = size ? {product, price, size} : {product, price};
		...
		currentCart.forEach((c) => {
			totalCartHtml += '<div class="mini-cart-item"><div class="mini-cart-item-image"><a href="product-details.html"><img src="assets/img/cart/1.png" alt="mini-cart-img"></a></div><div class="mini-cart-item-des"><a href="product-details.html">'+c.product+'</a><span class="mini-cart-item-price"><b>$'+c.price+'</b></span><span class="mini-cart-item-quantity">Qty: 1</span><span class="cart-cross-btn">x</span></div></div>'
		})
		$(".mini-cart-items").html(totalCartHtml)

		$(".icon-notify").css("background", "#C5853A")
		$(".icon-notify").text(currentCart.length)
	})
	...
	if(localStorage.getItem("cart")){
		...
		cart.forEach((c) => {
			if(!c.size){
				...
				totalCartHtml += '<div class="mini-cart-item"><div class="mini-cart-item-image"><a href="product-details.html"><img src="assets/img/cart/1.png" alt="mini-cart-img"></a></div><div class="mini-cart-item-des"><a href="product-details.html">'+c.product.split("-").join(" ")+ ', '+c.size+'</a><span class="mini-cart-item-price"><b>$'+c.price+'</b></span><span class="mini-cart-item-quantity">Qty: 1</span><span class="cart-cross-btn">x</span></div></div>'
			}
		})
		$(".mini-cart-items").html(totalCartHtml)
	}
